  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation, hands-on learning, and personalized mentorship, our diverse range of programs offers the perfect pathway to achieve your goels and unlock your full potential pathway to achieve your goals and unlock your full potential in shaping the future of education.</p>
